        ...
        <div className="px-6 py-6">
          <div className="bg-white rounded-2xl border border-gray-100 p-6 mb-5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-sm font-bold text-[#35322B]">This Month's Letter</p>
                <p className="text-xs text-[#6B6660]">From the Nuppu Digital team</p>
              </div>
            </div>

            <div className="mb-4">
              <div className="flex items-center gap-2 text-[#6E4FD1] mb-1.5">
                <Mail className="w-4 h-4" />
                <p className="text-xs font-semibold uppercase tracking-wide">Theme of the month</p>
              </div>
              <p className="text-sm text-[#35322B] font-semibold">Naming big feelings, gently</p>
            ...
            <div className="bg-[#F9E5A8]/30 rounded-xl p-4 flex gap-2.5">
              <Heart className="w-4 h-4 text-[#6E4FD1] shrink-0 mt-0.5" />
              <p className="text-xs text-[#55504A] leading-relaxed">
          ...
          <p className="text-[11px] text-[#6B6660] text-center leading-relaxed">
