          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div
                ...
                className="inline-block px-4 py-2 bg-[#C9BBF5]/30 rounded-full mb-6"
              >
                <span className="text-[#6E4FD1]">{t("home.badge")}</span>
              </motion.div>
              ...
              >
                {t("home.heroTitle")}{" "}
                <span className="text-[#6E4FD1]">{t("home.heroTitleHighlight")}</span>
              </h1>

              <p className="text-lg md:text-xl text-[#6B6660] mb-8 leading-relaxed">
                {t("home.heroSubtitle")}
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <button
                onClick={prevSlide}
                className="p-3 rounded-full bg-[#C9BBF5] text-white hover:bg-[#6E4FD1] transition-colors"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {targetAudiences.map((audience, index) => (
              ...
              >
                ...
                <h3
                  className="text-xl mb-4 text-[#35322B]"
                  style={{ fontFamily: 'Nunito, sans-serif' }}
                >
                  {audience.title}
                </h3>
                ...
                <ul className="space-y-3">
                  {audience.benefits.map((benefit, idx) => (
                    <li key={idx} className="flex items-center gap-2 text-[#6B6660]">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#6E4FD1]" />
                      {benefit}
                    </li>
                  ))}
                </ul>
